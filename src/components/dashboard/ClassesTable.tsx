        ...
        <DialogContent className="sm:max-w-[425px] bg-slate-900 border-white/10 text-white">
          ...
          <form onSubmit={addForm.handleSubmit(onAdd)} className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={(val) => addForm.setValue("teacher_id", val === "none" ? null : val)} defaultValue="none">
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={(val) => addForm.setValue("academic_year_id", val === "none" ? null : val)} defaultValue="none">
                <SelectTrigger className="border-white/10 bg-white/5 text-white focus:ring-yellow-400/30">
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="sm:max-w-[425px] bg-slate-900 border-white/10 text-white">
          ...
          <form onSubmit={editForm.handleSubmit(onEdit)} className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              <Label className="text-white/80">Wali Kelas</Label>
              <Select onValueChange={(val) => editForm.setValue("teacher_id", val === "none" ? null : val)} defaultValue={selectedClass?.teacher_id ?? "none"}>
                <SelectTrigger className="border-white/10 bg-white/5 text-white focus:ring-yellow-400/30">
                  <SelectValue placeholder="Pilih guru" />
                </SelectTrigger>
                <SelectContent className="border-white/10 bg-slate-900 text-white max-h-48">
            ...
            <div className="space-y-2">
              <Label className="text-white/80">Tahun Ajaran</Label>
              <Select onValueChange={(val) => editForm.setValue("academic_year_id", val === "none" ? null : val)} defaultValue={selectedClass?.academic_year_id ?? "none"}>
                <SelectTrigger className="border-white/10 bg-white/5 text-white focus:ring-yellow-400/30">
                  <SelectValue placeholder="Pilih tahun ajaran" />
                </SelectTrigger>
                <SelectContent className="border-white/10 bg-slate-900 text-white max-h-48">
